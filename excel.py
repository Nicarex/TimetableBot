...
try:
    import xlsxwriter
    Workbook = getattr(xlsxwriter, 'Workbook', None)
    if Workbook is None:
        raise ImportError('xlsxwriter.Workbook not found')
except Exception:
    import os
    import zipfile
...
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
            ...
            with zipfile.ZipFile(self.filepath, 'w', compression=zipfile.ZIP_DEFLATED) as z:
